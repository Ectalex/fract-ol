...
/*   Updated: 2023/12/16 13:45:34 by albriffa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_burn_ship(double x, double y, t_mlx *mlx)
{
	...
	c[0] = (x / WIDTH * 4 - 2.25 - (mlx->fract.x1 / 2)) * mlx->fract.zoom - mlx->fract.x1;
	c[1] = (y / HEIGHT * 4 - 2.25 - (mlx->fract.y1 / 2)) * mlx->fract.zoom - mlx->fract.y1;
	z[0] = mlx->fract.x2;
	z[1] = mlx->fract.y2;
	i = 0;
